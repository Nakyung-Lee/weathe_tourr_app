...
while True:
   ...
   #데이터 수신
    ...
    one = pd.read_csv('one.csv',encoding='euc-kr')
    two = pd.read_csv('two.csv',encoding='euc-kr')
    three = pd.read_csv('three.csv',encoding='euc-kr')
    four = pd.read_csv('four.csv',encoding='euc-kr')
    five = pd.read_csv('five.csv',encoding='euc-kr')
    six = pd.read_csv('six.csv',encoding='euc-kr')
    seven = pd.read_csv('seven.csv',encoding='euc-kr')
    eight = pd.read_csv('eight.csv',encoding='euc-kr')
    nine = pd.read_csv('nine.csv',encoding='euc-kr')
    ten = pd.read_csv('ten.csv',encoding='euc-kr')
    eleven = pd.read_csv('eleven.csv',encoding='euc-kr')
    twelve = pd.read_csv('twelve.csv',encoding='euc-kr')
...
#--user emlearn
   ...
   #클라이언트에게 답을 보냄
    conn.sendall(res[1].encode("utf-8"))
   #연결 닫기
    conn.close()
    break
s.close()
